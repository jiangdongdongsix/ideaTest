...
public class MenuController {
    ...
    public String updateMenuAvailable(@RequestParam(value = "menuId")Long menuId,@RequestParam(value = "menuAvailable")String menuAvailable){

        JSONObject jsonObject=new JSONObject();
        try{
            String msg=menuService.updateAvailableState(menuId,menuAvailable);
